...
const page = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-x-[45px] text-[#EFEBE5] p-[40px] h-[calc(100vh-233px)]  grid-cols-1">
        <div className="bg-[#C7C6C50D] rounded-[16px] !w-[55%] !h-full "></div>
        <div className=" rounded-[16px] !w-[45%] !h-full ">
          <h1 className="pb-[20px]  border-b border-[#6D6E7D]  text-[3rem] font-[400]">
            Mshatta Façade
          </h1>
          <div className="py-[20px] border-b border-[#6D6E7D]">
            <span className="text-[0.818rem] font-[400]">Contributed by</span>
            <p className="text-[1.189rem] font-[700]">Mansoor Alemy</p>
          </div>
          <div className="py-[20px] border-b border-[#6D6E7D]">
            <p

...
const MoreImagesBtn = () => {
  return (
    <div className="  z-[10000] relative  bg-[#C7C6C5] hover:bg-[#696867] hover:scale-[120%] transition-all duration-300 mx-auto flex gap-x-[10px] w-fit  px-[15px] py-[15px] rounded-full">
      <div
        className={`  flex-row  w-auto gap-x-[10px]    items-center flex  justify-center  transition-all duration-500  text-center  z-10  cursor-pointer rounded-full `}
      >
        <div style={{ display: "block", maxWidth: "fit-content" }}>
          <p className="text-[#253143] text-[14px] font-[500] whitespace-nowrap inline-block">
            More Images
          </p>
        </div>{" "}
        <svg
